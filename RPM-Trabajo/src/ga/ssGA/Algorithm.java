...
public class Algorithm
{
  ...
  private  ga.Individual aux_indiv;  // Internal auxiliar individual being computed


  // CONSTRUCTOR
  public Algorithm(ga.Problem p, int popsize, int gn, int gl, double pc, double pm)
  throws Exception
  {
    this.gene_number   = gn;
    this.gene_length   = gl;
    ...
    this.r             = new Random();
    this.aux_indiv     = new ga.Individual(chrom_length);
  ...
  // BINARY TOURNAMENT
  public ga.Individual select_tournament() throws Exception
  {
    int p1, p2;
  ...
  // DE OTHER)
  public ga.Individual SPX (ga.Individual p1, ga.Individual p2)
  {
    int       rand;
  ...
  public ga.Individual mutate(ga.Individual p1)
  {
    byte alelle=0;
    Random r = new Random();
  ...
  public void replace(ga.Individual new_indiv) throws Exception
  {
  ...
  private double evaluateStep(ga.Individual indiv)
  {
  ...
  public ga.Individual get_solution() throws Exception
  {
...
public double get_BESTF()  { return pop.get_BESTF();  }
  ...
  public ga.Individual get_ith(int index) throws Exception
  {
    return pop.get_ith(index);
  }

  public void set_ith(int index, ga.Individual indiv) throws Exception
  {
